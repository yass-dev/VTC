...
(function ($) {
	$.pickmeup = $.extend($.pickmeup || {}, {
		...
		locale			: {
			...
			months: ['Janvier', 'Février', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Aaout', 'Septembre', 'Octobre', 'Novembre', 'Decembre'],
			monthsShort: ['Jan', 'Fév', 'Mar', 'Avr', 'Mai', 'Juin', 'Juil', 'Aout', 'Sep', 'Oct', 'Nov', 'Dec']
		}
	});
